                    ...
                    <form method="post" enctype="multipart/form-data" accept-charset="utf-8" role="form" autocomplete="off" novalidate="novalidate" action="/revenue/priceformula1/<?php echo $vehicleId;?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group form-inline">
                                ...
                                <input type="text" value="<?php echo !empty($detail['normal_price']) ? number_format($detail['normal_price']) : '';?>" name="normal_price" class="form-control txtMoney">
                            </div>
                            <div class="form-group form-inline">
                            ...
                            <div class="form-group form-inline">
                                ...
                                <input type="text" value="<?php echo !empty($detail['day_night_price']) ? number_format($detail['day_night_price']) : '';?>" name="day_night_price" class="form-control txtMoney">
                            </div>
                        </div>
                        <div class="col-sm-8 col-sm-offset-4">
                            <div class="form-group form-inline">
                                ...
                                <input type="text" value="<?php echo !empty($detail['over_minute_price']) ? number_format($detail['over_minute_price']) : '';?>" name="over_minute_price" class="form-control txtMoney">
                            </div>
                        </div>
