...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $BASE_URL ?>/adminlte/dist/css/skins/skin-custom.css?<?php echo VERSION_DATE ?>"/>
    ...
    <body id="container_<?php echo $controller . '_' . $action; ?>" class="skin-custom sidebar-mini layout-top-nav">
